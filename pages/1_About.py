...
def Content():
    with st.expander("What is this about?",expanded=True):
    ...
    with st.expander("What does the roadmap look like?",expanded=True):
    ...
    with st.expander("What am I interested in?",expanded=True):
