...
INT_Value = df[df["Status"] == "Interview"].shape[0]
...
def Absolute_METRICS():
    ...
    col4.metric(label= 'No Answer Expected*', value= NAE_Value, delta=NAE_Delta, delta_description='*>1 Month', delta_color='violet', delta_arrow='off')
